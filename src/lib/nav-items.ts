...
export const navItems = [
  ...
  { href: '/requests', icon: FileText, label: 'طلبات الموظفين', adminOnly: false },
  { href: '/dashboard', icon: LayoutDashboard, label: 'لوحة التحكم', adminOnly: true },
  ...
  { href: '/admin/requests', icon: FileText, label: 'إدارة الطلبات', adminOnly: true },
